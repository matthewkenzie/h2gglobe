...
def doqqbar():
  ...
  grSpec = r.TGraph()
  grSpec.SetPoint(0,qqbarPoints[0]*100.,-2.8)
  grSpec.SetPoint(1,qqbarPoints[1]*100.,-2.4)
  grSpec.SetPoint(2,qqbarPoints[2]*100.,-1.4)
  grSpec.SetPoint(3,qqbarPoints[3]*100.,0.2)
  grSpec.SetPoint(4,qqbarPoints[4]*100.,2.4)
  grSpec.SetLineColor(r.kMagenta-4)
  grSpec.SetMarkerStyle(r.kFullCircle)
  grSpec.SetMarkerColor(r.kMagenta-4)
  grSpec.SetLineWidth(2)
  leg.AddEntry(grSpec,"Inject 2^{+}_{m} (100\%gg)","lp")

  grSpec2 = r.TGraph()
  grSpec2.SetPoint(0,qqbarPoints[0]*100.,3.2)
  grSpec2.SetPoint(1,qqbarPoints[1]*100.,1.4)
  grSpec2.SetPoint(2,qqbarPoints[2]*100.,-0.2)
  grSpec2.SetPoint(3,qqbarPoints[3]*100.,-1.0)
  grSpec2.SetPoint(4,qqbarPoints[4]*100.,-1.4)
  grSpec2.SetLineColor(r.kMagenta+2)
  grSpec2.SetMarkerStyle(r.kFullCircle)
  grSpec2.SetMarkerColor(r.kMagenta+2)
  grSpec2.SetLineWidth(2)
  leg.AddEntry(grSpec2,"Inject 2^{+}_{m} (100\%q#bar{q})","lp")
